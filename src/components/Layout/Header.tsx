          ...
          authenticated ? (
            <div className="relative">
              <Button
                ...
                onClick={handleClick}
              >
                  <User className="hover:bg-blue-300/50 transition-colors rounded-full p-2" size={40} color="#000" />
              </Button>
              <Menu
                id="basic-menu"
                anchorEl={anchorEl}
            ...
            <Link to="/login" className="text-blue-500 border-2 border-blue-500 font-semibold px-6 py-1.5 hover:bg-blue-500 hover:text-white rounded transition-colors hover:shadow-md">Entrar</Link>
          )
        }
